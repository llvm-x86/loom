 ...
 *
 * Handles `loom setup` for onboarding and `loom setup <component>` for optional dependencies.
 */
...
// package dependencies beyond a working interpreter. `loom setup python --check`
...
/**
 * Unified `loom setup speech` flow. Drives every {@link SpeechComponent} through
