...
Collab session started!
 • Join from another terminal: loom join "mgAYTZwEnpRQtca0CTgn-Q.gdJUbTovD94ofDaa8YvhY0-ty16w4fn8PgB6PLnoA30"
...
Accepted by `/join <link>` and `loom join "<link>"`:
